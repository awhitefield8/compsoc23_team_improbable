...
#implement approach 3 - convergence voting - run as many iterations as possible


### Rule 2

def my_rule2(profile: Profile, candidate: int) -> int:
    """
...
def my_rule3(profile: Profile, candidate: int) -> int:
    """
    Calculates the Copeland score for a candidate based on a profile.
